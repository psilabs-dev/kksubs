...
from kksubs.core.data.subtitle.style_attributes import OutlineData
...
# from kksubs.core.data.subtitle.subtitle import OutlineData, Subtitle
from kksubs.core.service.processor.motion_blur import apply_motion_blur
from kksubs.core.service.processor.apply_text import create_text_layer
...
def _get_default_font():
    ...
    try:
        ...
        font_files = importlib.resources.files('kksubs.resources.fonts.roboto')
