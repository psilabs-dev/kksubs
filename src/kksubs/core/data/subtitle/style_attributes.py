...
import kksubs.core.data.subtitle.style
from kksubs.core.data.abstract import BaseData
from kksubs.common.utils.coalesce import coalesce
from kksubs.core.utils.sanitizers import to_float, to_integer, to_rgb_color, to_string, to_validated_value, to_xy_coords
...
class CharacterDialogueConfig(BaseData):
    ...
    def deserialize(cls, data=None):
        ...
        character = kksubs.core.data.subtitle.style.Style.deserialize(character_data) if character_data is not None else None
        dialogue = kksubs.core.data.subtitle.style.Style.deserialize(dialogue_data) if dialogue_data is not None else None
